...
const steps = [
  ...
  },
  {
    ...
    options: [
      {
        value: "Our products",
        label: "Learn about our products",
        trigger: "products",
      },
      {
        value: "domains",
        label: "Learn about our domains",
        trigger: "domains",
      },
      {
        value: "services",
  ...
  },
  {
    id: "products",
    message:
      "We offer several products including ATPLC, SmartOne, Startup Awareness and Mentorship Program (SAMP), and Company Registration and Compliances Services (CRCS). Would you like to know more about a specific product?",
  ...
  },
  {
    id: "domains",
    message:
      "Our domains include training & internships, hardware & software development, company registration, and company compliance support. Would you like more details on any of these domains?",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        label: "Hardware & Software Development",
      ...
      {
        value: "compliance",
        label: "Company Compliance Support",
        trigger: "compliance",
      },
    ],
  },
  {
    id: "training",
    message:
      "We offer comprehensive training and internship programs in various fields.",
    trigger: "more-help",
  },
  {
    id: "hardware-software",
    message:
      "We provide hardware and software development services tailored to your needs.",
    trigger: "more-help",
  },
  {
    id: "registration",
  ...
  },
  {
    id: "compliance",
    message:
      "We offer support for maintaining company compliance with legal and regulatory requirements.",
    trigger: "more-help",
  },
  {
    id: "services",
    message:
      "Our services include training & internships, hardware & software development, company registration, and company compliance support. Would you like to know more about a specific service?",
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: "hardware-software-service",
        label: "Hardware & Software Development",
        trigger: "hardware-software-service",
      },
      {
  ...
  },
  {
    id: "training-service",
    message:
      "Our training and internship services are designed to provide hands-on experience and industry knowledge.",
    trigger: "more-help",
  },
  {
    id: "hardware-software-service",
    message:
      "Our hardware and software development services include custom solutions to meet your business needs.",
    trigger: "more-help",
  },
  {
    id: "registration-service",
    message:
      "Our company registration services ensure a smooth and efficient registration process.",
    trigger: "more-help",
  },
  {
    id: "compliance-service",
    message:
      "Our company compliance support services help you stay compliant with all necessary regulations.",
    trigger: "more-help",
  },
  {
    id: "contact",
    message:
      "You can contact us via email at contact2atplc@gmail.com or call us at +91 6205695667.",
  ...
  },
  {
    id: "about",
    message:
      "We are a dynamic service and product-based company, Lyss Technology, established in 2024. Discover more about our mission and vision on our About page.",
...
export const ReactChatBot = () => {
  ...
  const handleMouseMove = (e) => {
    if (isDragging) {
      ...
      bot.style.left = rect.left + e.movementX + 'px';
      bot.style.top = rect.top + e.movementY + 'px';
    }
  };
  const handleMouseUp = () => {
    setIsDragging(false);
