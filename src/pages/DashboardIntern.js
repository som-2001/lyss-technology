...
import Footer from "../components/Footer";
  ...
  export const DashboardIntern= () => {
    ...
    return (
      ...
      >
        <Helmet>
          <title>Lyss Technology Pvt. Ltd. | Intern Dashboard</title>
        </Helmet>
        <Navbar />
    ...
    >
      ...
      >
        <Grid item xs={12} sm={12} lg={6} md={6}>
          ...
          >
            The Intern Dashboard is a centralized hub designed to empower interns with quick access to essential tools, resources, and personalized information, streamlining daily tasks and enhancing overall productivity.
          </Typography>
        </Grid>
